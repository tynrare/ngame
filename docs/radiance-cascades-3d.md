...
<!-- agent: composer-2.5 | 2026-08-10 | doc sparse trilinear resolve | 33ef2d -->
...
| Merge / SH / Resolve | T-merge → L1 SH; resolve **sparse trilinear** (8-corner hash) |
...
4. Fill/merge/SH on **dirs × slots** atlas; resolve sparse trilinear (8 corners; skip miss); fill blend-off.
...
| `SELF_T_MIN` / resolve | ~0.1 / sparse trilinear + bias |
